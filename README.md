...
- Deep Jointly-Informed Neural Networks (DJINN)
    - Use DJINN to replace the matrix-vector multiplication (&sigma;<sup>s</sup>&phi;
    and &sigma;<sup>f</sup>&phi;) in the neutron transport equation.
    - Memory reduced by upwards of 98% of original footprint.
    - **Citation:** Ben Whewell and Ryan G. McClarren, (2022). Data Reduction in
...
- Collision-Based Hybrid Method
    - Separate the collided and uncollided terms in the neutron transport equation
    to use on different energy and angle grids.
    - High fidelity grids for the uncollided solve (one sweep) with low fidelity
    grids on the collided solve.
    - More accurate than both portions using the low fidelity and faster than using
    the high fidelity grid.
    - **Citation:** Ben Whewell, Ryan G. McClarren, Cory D. Hauck, and Minwoo Shin,
