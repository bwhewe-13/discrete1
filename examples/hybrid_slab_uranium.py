...
layout = [[0, "stainless-steel-440", "0-4, 6-10"], \
             [1, "uranium-%20%", "4-6"]]
...
mg_flux = timed1d.backward_euler(flux_last, xs_total, xs_scatter, xs_fission, \
                    velocity, external, boundary, medium_map, delta_x, angle_x, \
                    angle_w, bc_x, steps=steps, dt=dt, geometry=1)


hy_flux = hybrid1d.auto_bdf1(flux_last, xs_total, xs_scatter, xs_fission, \
                        velocity, external, boundary, medium_map, delta_x, \
                        angle_x, angle_w, bc_x, angles_c, groups_c, \
                        energy_grid, steps=steps, dt=dt, geometry=1)
