"""Compare hybrid and variable-hybrid time-dependent slab solvers."""
...
# groups_c = np.array([groups_c] * steps)
# angles_c = np.array([angles_c] * steps)

groups_c = np.array([43, 43, 43, 43, 43])
angles_c = np.array([4, 4, 4, 4, 4])
