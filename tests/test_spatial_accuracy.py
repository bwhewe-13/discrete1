...
def test_mms_ss_si_01(angular, edges):
    ...
    for cells_x in cells_list:
        ...
        xs_total, xs_scatter, xs_fission, external, boundary, medium_map, \
            delta_x, angle_x, angle_w, edges_x, bc_x = data

        flux = source_iteration(xs_total, xs_scatter, xs_fission, external, \
                            boundary, medium_map, delta_x, angle_x, angle_w, \
                            bc_x, geometry=1, angular=angular, edges=edges)
...
def test_mms_ss_dmd_01(angular, edges):
    ...
    for cells_x in cells_list:
        ...
        flux = dynamic_mode_decomp(xs_total, xs_scatter, xs_fission, external, \
                            boundary, medium_map, delta_x, angle_x, angle_w, \
                            bc_x, geometry=1, angular=angular, edges=edges, \
                            R=2, K=5)
